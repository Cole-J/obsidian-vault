...
Constructors, like functions, can be [[overloading in java|overloaded]] with multiple different options for passing different parameters. See the link for more.
