...
- First create a table for each Strong Entity Set. (converting Entity Sets)
...
- Any Weak Entity Sets also get a table but:
	- The attributes of the Weak Entity Set are the union of the primary key of the owning / identifying Entity Set, and the attributes of the weak entity set. The primary key is then the union of the primary key of the owning / identifying Entity Set and the discriminator of the Weak Entity Set.
